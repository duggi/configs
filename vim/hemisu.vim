...
let s:brite=           { "gui": "#ff0000", "cterm": "9" }

let s:darkPink=        { "gui": "#63001C", "cterm": "232"  }
...
if version >= 700
  ...
  call s:h("MatchParen",  { "fg": s:brite, "bg": s:faint, "gui": "bold" })
...
call s:h("StatusLine",   { "fg": s:norm, "bg": s:subtle, "gui": "bold", "cterm": "bold" })
