...
if version >= 700
  ...
  hi MatchParen   guifg=#f6f3e8 guibg=#857b6f gui=bold  ctermfg=9   ctermbg=0 cterm=bold
...
hi Normal       guifg=#f6f3e8 guibg=#242424 gui=none   ctermfg=253  ctermbg=234  cterm=none
hi NonText      guifg=#808080 guibg=#303030 gui=none   ctermfg=244  ctermbg=236  cterm=none
hi LineNr       guifg=#857b6f guibg=#000000 gui=none   ctermfg=232  ctermbg=233  cterm=none
...
hi Folded       guibg=#384048 guifg=#a0a8b0 gui=none   ctermfg=248  ctermbg=237  cterm=none
...
" Syntax highlighting
hi Comment    guifg=#99968b gui=italic ctermfg=239       cterm=none
