...
if &background == 'dark'
  ...
  let s:gb.light0 = ['fff6c4', 229]     " 253-244-193
  let s:gb.light1 = ['f0ecc0', 223]     " 235-219-178
  ...
  let s:gb.black  = ['111111', 0]     " 40-40-40
  "let s:gb.red    = ['fb4934', 167]     " 251-73-52
  let s:gb.red    = ['ddccbb', 167]     " 251-73-52
  let s:gb.ruby   = ['cc3300', 167]     " 251-73-52
  "let s:gb.green  = ['b8bb26', 142]     " 184-187-38
  let s:gb.green  = ['aaddb0', 142]     " 184-187-38
  let s:gb.yellow = ['ddddaa', 214]     " 250-189-47
  ...
  let s:gb.orange = ['ffeeaa', 208]     " 254-128-25

  let s:gb.real_red    = ['ff0000', 167]     " 251-73-52
  let s:gb.real_yellow = ['ffff00', 214]     " 250-189-47
  ...
  if g:gruvbox_termcolors == 16
    ...
    let s:gb.real_red    = ['9d0006', 9]
    let s:gb.green  = ['79740e', 10]
    let s:gb.yellow = ['b57614', 11]
    let s:gb.real_yellow = ['b57614', 11]
...
if version >= 703
  ...
  call s:HL('ColorColumn',  'ruby', 'none', 'underline')

  " Concealed element: \lambda → λ
  call s:HL('Conceal', 'blue', 'none')

  " Line number of CursorLine
  call s:HL('CursorLineNr', 'orange', 'orange')
endif
...
"call s:HL('StatusLine',   'black', 'red', 'inverse')
"call s:HL('StatusLineNC', 'dark0', 'dark2', 'bold,inverse')
call s:HL('StatusLine',   'aqua', 'black', 'inverse')
call s:HL('StatusLineNC', 'black', 'dark2', 'bold,inverse')

" The column separating vertically split windows
call s:HL('VertSplit', 'light4', 'dark0')
...
call s:HL('Cursor', 'real_yellow', 'real_red', 'inverse')
" Visual mode cursor, selection
call s:HL('vCursor', 'yellow', 'none', 'inverse')
" Input moder cursor
call s:HL('iCursor', 'yellow', 'none', 'inverse')
...
call s:HL('Todo', 'black', 'ruby', 'bold')
...
function! gruvbox#hls_show()
  set hlsearch
  call s:HL('Cursor',  'orange', g:gruvbox_hls_cursor)
  call s:HL('vCursor', 'orange', g:gruvbox_hls_cursor)
  call s:HL('iCursor', 'orange', g:gruvbox_hls_cursor)
  call s:HL('lCursor', 'orange', g:gruvbox_hls_cursor)
endfunction
