...
if s:style == "light"
    ...
    if s:contrast == "low"
        ...
        hi StatusLine   guifg=#ffffff   guibg=#ddbb99
        hi StatusLineNC guifg=#999999   guibg=#cccccc
